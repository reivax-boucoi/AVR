...
const String TXT_TEMPERATURE_C    = "Température (°C, min-jour-max)";
...
//RainFall / SnowFall
const String TXT_RAINFALL_MM = "Pluie (mm/jour)";
...
//Day of the week
const char* weekday_D[] = { "Dimanche", "Lundi", "Mardi", "Mercredi", "Jeudi", "Vendredi", "Samedi" };
const char* weekday_D_short[] = { "Dim", "Lun", "Mar", "Mer", "Jeu", "Ven", "Sam" };

//Month
const char* month_M[] = { "Janvier", "Février", "Mars", "Avril", "Mai", "Juin", "Juillet", "Août", "Septembre", "Octobre", "Novembre", "Décembre" };
